...
let responsive = [
  ...
  //{ breakPoint: { width: 700, item: 3 } }, //if width greater than 600 (2  item will show)
...
function start() {
  ...
  for (let i = 1; i <= allSlides; i++) {
    ...
    li.id = i;
    //  li.innerHTML = i;
    li.addEventListener('click', controlSlides);
    ul.appendChild(li);
    if (i == 1) {
      li.className = 'active';
    }
